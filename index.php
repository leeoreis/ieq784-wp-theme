<?php
/**
 * Template padrão - Redireciona para página em construção ou chomneq2025
 * 
...
if (function_exists('is_home') && is_home() && !is_paged()) {
    ...
    if ($em_construcao) {
        include(locate_template('page-em-construcao.php'));
        exit;
    }
}
...
<div class="container" style="padding: 4rem 0; text-align: center;">
    ...
    <a href="<?php echo home_url('/chomneq2025'); ?>" class="btn-ver-mais">Ir para o Catálogo de Expositores</a>
</div>
